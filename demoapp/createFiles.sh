...
oc create -f katacoda-scenariosdemoapp/assets/pv1.yaml
oc create -f katacoda-scenariosdemoapp/assets/pv2.yaml
oc create -f katacoda-scenariosdemoapp/assets/pv3.yaml
oc create -f katacoda-scenariosdemoapp/assets/pv4.yaml
